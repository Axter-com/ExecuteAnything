...
NppData CNppMessager::m_nppData = { 0, 0, 0 };
HMENU CNppMessager::m_nppMainMenu = NULL;
HMENU CNppMessager::m_nppPluginMenu = NULL;
HMENU CNppMessager::m_thisPluginMenu = NULL;

const NppData&  CNppMessager::getNppData()
{
	return m_nppData; 
}
